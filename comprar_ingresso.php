<?php
      ...
      if (!$tipoPagamento) {
          ...
          */
          ...
          if (!isset($erro2)) {
              ...
              // Mantemos apenas a opção Pix (antigo pix2), agora rebatizado como "pix":
  ...
  <head>
    ...
    <!-- Se não for usar Mercado Pago, esta parte pode ser removida
    <script src="https://sdk.mercadopago.com/js/v2"></script>
    <script>
      const mp = new MercadoPago('SUA_PUBLIC_KEY_MERCADOPAGO');
    </script>
    -->
          ...
          <div class="form-column">
            ...
            <?php elseif ($step == 2): ?>
              ...
              <form method="post" action="">
                ...
                <!-- Botão para Cartão (em breve) -->
                <div class="form-group card-button-container">
                  <!-- TODO: implementar lógica de pagamento por cartão -->
                  <button type="button" class="btn-card-animated" disabled>
